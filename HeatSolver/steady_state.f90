...
!   Local
    ...
    !
    allocate( power_initial(matrix_length-2) )
    allocate( elem_node_lengths(matrix_length-2) )
...
!   Apply to every node point within an element
    ...
    print *,'power',power_initial
!---Set initial soln guess
    previous_elem_soln_vec(matrix_length-1) = 1.0
    previous_elem_soln_vec(matrix_length)   = 1.0
